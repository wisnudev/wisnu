...
async function writeExif(media, data) {
    ...
    if (data) {
        ...
        const { wra = data.pack_id ? data.pack_id : global.author ? global.author : 'wisnu-dev', wrb = data.packname ? data.packname : global.packname ? global.packname : 'Bot WhatsApp', wrc = data.author ? data.author : global.author ? global.author : 'wisnudev', wrd = data.categories ? data.categories : [''], wre = data.isAvatar ? data.isAvatar : 0, ...wrf } = data
